...
- **Visible obligations:** `agent_observe` lists your open incoming Requests by ID, requester, and title, or retrieves the exact full Request by ID/unique suffix. Answer receipts identify the originating Request by title and ID.
